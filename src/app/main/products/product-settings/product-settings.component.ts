...
export class ProductSettingsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.addProductPermission = accountPermissions.some((p: any) => p == "addProduct");
    this.editProductPermission = accountPermissions.some((p: any) => p == "changeProduct");
    this.deleteProductPermission = accountPermissions.some((p: any) => p == "removeProduct");
    this.refresh();
  }
